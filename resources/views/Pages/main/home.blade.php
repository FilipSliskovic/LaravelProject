...
<div class="offer container-fluid my-5 py-5 text-center position-relative overlay-top overlay-bottom">
    <div class="container py-5">
        ...
        <h4 class="text-white font-weight-normal mb-4 pb-3">Only for Sunday from 1st Jan to 30th Jan 2045 on all rezervations</h4>
        @if(\Illuminate\Support\Facades\Auth::check())
                <div class="col col-md-3 m-auto">
                    <a class="btn btn-primary font-weight-bold " href="{{route('Rezervation-index')}}">Make a reservation!</a>
                </div>
        @else
            <div class="col col-md-3 m-auto">
                <a class="btn btn-primary font-weight-bold " href="{{route('Login-index')}}">Log in!</a>
            </div>
        @endif
